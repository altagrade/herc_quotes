...
/**
 * Plugin implementation of the 'herc_quotes_purchase_default' formatter.
 *
 * @FieldFormatter(
 *   id = "herc_quotes_purchase_default",
 *   label = @Translation("Default"),
 *   field_types = {
 *     "herc_quotes_purchase"
 *   }
 * )
 */
class JobquotePurchaseDefaultFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new JobquotePurchaseDefaultFormatter object.
   *
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    /** @var \Drupal\herc_quotes\Plugin\Field\FieldType\JobquotePurchaseItem $item */
