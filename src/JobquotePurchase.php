...
/**
 * Provides a value object for jobquote purchases.
 */
final class JobquotePurchase {
  ...
  /**
   * Constructs a new JobquotePurchase object.
   *
   * @param int $order_id
   *   The order id.
  ...
  public static function fromArray(array $purchase) {
    if (!isset($purchase['order_id'], $purchase['quantity'], $purchase['purchased'])) {
      throw new \InvalidArgumentException('JobquotePurchase::fromArray() called with a malformed array.');
    }
